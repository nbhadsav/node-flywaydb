...
module.exports = {
    ...
    clean: function(config) { return exeCommand(config, { _name: 'clean' } )},
    info: function(config) { return exeCommand(config, { _name: 'info' } )},
    validate: function(config) { return exeCommand(config, { _name: 'validate' } )},
    baseline: function(config) { return exeCommand(config, { _name: 'baseline' } )},
    repair: function(config) { return exeCommand(config, { _name: 'repair' } )}
};
